...
class SpotRoughEnvCfg(SpotFlatEnvCfg):
    def __post_init__(self):
        ...
        self.events.base_external_force_torque.params["asset_cfg"].body_names = "base"
        self.terminations.body_contact.params["sensor_cfg"].body_names = ["base", ".*thigh"]
        self.rewards.gait.params["synced_feet_pair_names"] = (("FL_foot", "RR_foot"), ("FR_foot", "RL_foot"))
        self.rewards.joint_acc.params["asset_cfg"].joint_names = ".*_joint"
        self.rewards.joint_vel.params["asset_cfg"].joint_names = ".*_joint"

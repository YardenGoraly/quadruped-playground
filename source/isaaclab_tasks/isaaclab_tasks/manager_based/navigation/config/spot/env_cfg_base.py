...
from isaaclab_tasks.manager_based.navigation.sensors import ZED_X_MINI_WIDE_RAYCASTER_CFG, adjust_ray_caster_camera_image_size
...
class NavTasksDepthNavSceneCfg(InteractiveSceneCfg):
    ...
    height_scanner = RayCasterCfg(
        ...
        ray_alignment="yaw",
        pattern_cfg=patterns.GridPatternCfg(resolution=0.1, size=[4, 3]),
        debug_vis=False,
...
class TerminationsCfg:
    ...
    leg_contact = DoneTerm(
        ...
        params={
            ...
            "sensor_cfg": SceneEntityCfg("contact_forces", body_names=["^.*_hip$", "^.*_uleg$", "^.*_lleg$"]),
            "threshold": 0.0,
        },
        time_out=False,
    )
